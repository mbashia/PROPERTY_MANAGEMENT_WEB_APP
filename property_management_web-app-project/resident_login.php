...
if (isset($_POST['submit'])) {
    ...
    $sql = "SELECT * FROM residents WHERE email = '$user_email' ";
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        if ($user_password == $user['password']) {
            ...
            $_SESSION['resident_name'] = $user['residentName'];
            $_SESSION['residentID'] = $user['residentsID'];
            $_SESSION['residence_name'] = $user['houseName'];
            sleep(0.5);
            // echo $_SESSION['resident_name'];
            // redirecting user to dashboard if login is successful
            header("Location: resident_site.php");
            exit();
        } else {
...
<head>
    ...
    <link rel="stylesheet" href="resident_login.css" type="text/css">
...
<body>
    <div class="form_div">
        ...
        <div class="sign_up_here">
            <p>don't have an account <a href="resident_sign_up.php">sign up here!!</a>.</p>
        </div>
